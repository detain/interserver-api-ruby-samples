...
response = client.call(:api_add_dns_record, message: {sid: ARGV[312],  domain_id: ARGV[313],  name: ARGV[314],  content: ARGV[315],  type: ARGV[316],  ttl: ARGV[317],  prio: ARGV[318],   })
